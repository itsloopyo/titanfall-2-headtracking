...
# Mod payload deployed to the game root by install.cmd. No config is shipped:
# the mod creates CameraUnlock.ini on first launch, importing HeadTracking.ini
# from an earlier version once.
